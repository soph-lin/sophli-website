    ...
    extend: {
      ...
      keyframes: {
        ...
        particle: {
          '0%': {
            transform:
              'translate(-50%, -50%) rotate(var(--particle-angle)) translate(0, 0)',
            opacity: '1',
          },
          '100%': {
            transform:
              'translate(-50%, -50%) rotate(var(--particle-angle)) translate(var(--particle-drift-x3), var(--particle-distance-3))',
            opacity: '0',
          },
        },
        'title-drop': {
        ...
        'title-float': {
          '0%, 100%': {
            transform:
              'translate(calc(var(--float-x, 0) * 0.5px), calc(var(--float-y, 0) * 0.5px)) rotate(calc(var(--float-r, 0) * 0.5deg))',
          },
          '50%': {
            transform:
              'translate(calc(var(--float-x, 0) * -0.5px), calc(var(--float-y, 0) * -0.5px)) rotate(calc(var(--float-r, 0) * -0.5deg))',
      ...
      animation: {
        ...
        'title-drop':
          'title-drop 0.4s cubic-bezier(0.175, 0.885, 0.32, 1.275) forwards',
